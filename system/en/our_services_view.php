    ...
    <div class="container">
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    <?php
                    $query = $con->query( " SELECT * FROM `our_services` where 1=1  ");
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                $query = $con->query("SELECT * FROM `our_services` ORDER BY `id` ASC");
                                $x = 1;
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX<?= $service_id ?>">
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="our_services_edit.php?serviceID=<?= $service_id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/our_services_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
