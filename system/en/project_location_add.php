...
<div id="wrapper">
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($errors)) {
            ...
            $con->query(" INSERT INTO `project_location` (`project_id`, `location`) VALUES ('$project_id' , '$location')");
                        ...
                        <div class="card-box">
                            ...
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" data-parsley-validate novalidate>
                                ...
                                <div class="form-group col-md-5">
                                    <label for="sub_cat_desc">Project Location Link</label>
                                    <input type="text" class="form-control" rows="3" name="location"  minlength="3" maxlength="1000" placeholder="Type The Location Link"></input>
                                </div>
