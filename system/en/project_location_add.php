                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?= lang('add_new_project_location')?> </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="m-t-0 header-title"><b><?= lang('add_new_project_location')?></b></h4>
                            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" data-parsley-validate novalidate>
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" class="form-control" rows="3" name="lat"  minlength="3" maxlength="1000" placeholder="<?= lang('location_lat')?>"></input>
                                </div>
                                <div class="form-group col-md-5">
                                    <label for="sub_cat_desc"><?= lang('location_long')?></label>
                                    <input type="text" class="form-control" rows="3" name="long"  minlength="3" maxlength="1000" placeholder="<?= lang('location_long')?>"></input>
                                </div>
