                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?=lang('project_drawing')?></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="">
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                $query = $con->query("SELECT * FROM `project_drawing` ORDER BY `id` ASC");
                                $x = 1;
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="engineering_drawing_edit.php?imagesID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/engineering_drawing_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
